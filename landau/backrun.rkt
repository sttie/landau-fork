  ...
  (begin
    ...
    (let ((rev-flat (splice-nested actions-list)))
      ...
      (let*
        ...
        ; (displayln "available-dx-table")
        ; (pretty-print available-dx-table)
        ...
        (for ((action (in-list rev-flat)))
          (match action
            ...
            (_ (void))))
                ...
                ; (pretty-print available-dx-table)
        ; ; (println "")
                ; (log-debug (format "discard-table: ~a" discard-table))
                ; (displayln "der-table:")
                ; (pretty-print der-table)
        ; (println "")
        ; (pretty-print (format "real-vars-table: ~a" real-vars-table))
        ; (println "")
